              ...
              <div className="row justify-content-center align-items-start mt-4">
                <div className="col-md-6 d-flex flex-column align-items-center">
                  ...
                  <a href="https://opensea.io/collection/bailarina-5" target="_blank" rel="noopener noreferrer" className="text-black fw-bold">
                    <Image src="/portfolio-site/artworks/work-5.png" alt="OpenSea Collection" width={300} height={300} className="img-fluid mb-3" style={{ maxHeight: '300px', objectFit: 'contain' }} />
                  </a>
                </div>
                <div className="col-md-6 d-flex flex-column align-items-center">
                  ...
                  <a href="https://stand.fm/episodes" target="_blank" rel="noopener noreferrer" className="text-black fw-bold">
                    <Image src="/portfolio-site/artworks/work-4.png" alt="Stand.fm Episodes" width={300} height={300} className="img-fluid mb-3" style={{ maxHeight: '300px', objectFit: 'contain' }} />
                  </a>
                </div>
              </div>
            </div>
        ...
        <div className="container">
          ...
          <div className="row justify-content-center mb-4">
            <div className="col-md-4 text-center mb-3" style={{ height: '300px', position: 'relative' }}>
              <Image src="/portfolio-site/artworks/work-11.png" alt="AI Art 1" fill style={{ objectFit: 'contain' }} />
            </div>
            <div className="col-md-4 text-center mb-3" style={{ height: '300px', position: 'relative' }}>
              <Image src="/portfolio-site/artworks/work-2.png" alt="AI Art 2" fill style={{ objectFit: 'contain' }} />
            </div>
            <div className="col-md-4 text-center mb-3" style={{ height: '300px', position: 'relative' }}>
              <Image src="/portfolio-site/artworks/work-3.png" alt="AI Art 3" fill style={{ objectFit: 'contain' }} />
            </div>
          </div>
          <div className="row justify-content-center">
            {/* Single Video */}
            <div className="col-md-8 text-center" style={{ backgroundColor: 'black', position: 'relative' }}>
              ...
              >
                <source src="/portfolio-site/artworks/work-video3.mp4" type="video/mp4" />
